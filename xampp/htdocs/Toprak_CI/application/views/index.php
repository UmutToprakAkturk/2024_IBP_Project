...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/dist/css/stylee.css">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>change" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>/assets/https://adminlte.io/docs/3.0" class="nav-link">
  ...
  <div class="content-wrapper">
	...
	<div class="table">
		<div class="table-header">
			<div class="header__item">Users' mails</div>
			<div class="header__item">Password</div>
		</div>
		<div class="table-content">	
				
      <?php foreach ($users as $user): ?>
        <div class="table-row">	
				<div  class="form-style"><?php echo $user->email; ?></div>
				<div  class="form-style"><?php echo $user->password; ?></div>
        </div>
      <?php endforeach; ?>
...
<br>
    ...
    <form action="<?php echo base_url("admin/update"); ?>"  method="post" class="header__item">
    <input type="email" name="logemail2" class="form-style" placeholder="Write down the person you want to change his Email" id="logemail2" autocomplete="off" required><br>
    
    <input type="email" name="logemail3" class="form-style" placeholder="New Email" id="logemail3" autocomplete="off" required><br>
    <input type="password" name="logpass3" class="form-style" placeholder="New Password" id="logpass3" autocomplete="off" required>
